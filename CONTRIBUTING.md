Contributing to Needycoin Core
============================

The Needycoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Needycoin Core project, and is not to be
confused with overall Needycoin Network Protocol consensus changes.

Whether a pull request is merged into Needycoin Core rests with the project merge
...
Patches that change Needycoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Needycoin consensus, it must have been
...
The project leader is the release manager for each Needycoin Core release.
