...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/needycoin-cli.cpp \
           src/needycoin-tx.cpp \
           src/needycoin.cpp \
           src/db.cpp \
           ...
           src/qt/needycoin.cpp \
           src/qt/needycoinstrings.cpp \
...
RESOURCES += src/qt/needycoin.qrc src/qt/needycoin_locale.qrc

TRANSLATIONS += src/qt/locale/needycoin_bg.ts \
                src/qt/locale/needycoin_de.ts \
                src/qt/locale/needycoin_en.ts \
                src/qt/locale/needycoin_es.ts \
                src/qt/locale/needycoin_fi.ts \
                src/qt/locale/needycoin_fr.ts \
                src/qt/locale/needycoin_it.ts \
                src/qt/locale/needycoin_ja.ts \
                src/qt/locale/needycoin_pl.ts \
                src/qt/locale/needycoin_pt.ts \
                src/qt/locale/needycoin_ru.ts \
                src/qt/locale/needycoin_sk.ts \
                src/qt/locale/needycoin_sv.ts \
                src/qt/locale/needycoin_vi.ts \
                src/qt/locale/needycoin_zh_CN.ts \
                src/qt/locale/needycoin_zh_TW.ts
