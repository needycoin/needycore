...
This means one can have an always-on needycoind instance running, and another local needycoind/needycoin-qt instance which connects to this node and receives blocks from it.
