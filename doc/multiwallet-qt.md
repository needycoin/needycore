...
In order to support loading of multiple wallets in needycoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is needycoin.cpp.
...
Changes to needycoin.cpp
----------------------
needycoin.cpp is the entry point into needycoin-qt, and as such, will require some minor modifications to provide hooks for
