...
// Copyright (c) 2020 The Needycoin developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (     29720, uint256("0xe33fddb2e0e1917bdec8fa68a9963695ec541a775d3f3d56bd466f595d4e964d"))
;
...
public:
    CMainParams()
    {
        ...
        nSubsidyHalvingInterval = 90000000;
        ...
        const char* pszTimestamp = "This is all you need to become part of Needy!";
        ...
        vSeeds.push_back(CDNSSeedData("seed2.needycoin.org", "seed2.needycoin.org"));
        vSeeds.push_back(CDNSSeedData("seed3.needycoin.org", "seed3.needycoin.org"));
        vSeeds.push_back(CDNSSeedData("seed4.needycoin.org", "seed4.needycoin.org"));
        vSeeds.push_back(CDNSSeedData("seed5.needycoin.org", "seed5.needycoin.org"));
        ...
        strSporkKey = "04b5a7abe35c46a8187867a664e878df330b7532c88b628e937c0bfe08572add3e52effa3d113042323bb2b3dcbf8ea64ba0b9659ff6212658ef16ec06d32de48c";
        strObfuscationPoolDummyAddress = "1E7DjtT2TakEpFHUHPp4eqyhattDrE3fGA";
...
public:
	...
	hashGenesisBlock = genesis.GetHash();
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet Needycoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet Needycoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet Needycoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Needycoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Needycoin BIP44 coin type is '1' (All coin's testnet default)
