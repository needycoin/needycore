/* src/config/needycoin-config.h.  Generated from needycoin-config.h.in by configure.  */
/* src/config/needycoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.needycoin.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Needycoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Needycoin Core 1.1.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "needycoin"
