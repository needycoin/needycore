...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Needycoin Core needycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  needycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded needycoin transaction") + "\n" +
                               "  needycoin-tx [options] -create [commands]   " + _("Create hex-encoded needycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded needycoin transaction
