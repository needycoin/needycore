    ...
    if (fMasterNode) {
        ...
        BOOST_FOREACH (const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Needycoin and make it unusable. To
...
bool CObfuscationPool::DoAutomaticDenominating(bool fDryRun)
{
    ...
    CAmount nBalanceNeedsAnonymized = nAnonymizeNeedycoinAmount * COIN - pwalletMain->GetAnonymizedBalance();
...
void ThreadCheckObfuScationPool()
{
    ...
    RenameThread("needycoin-obfuscation");
