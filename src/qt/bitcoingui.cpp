                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Needycoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Needycoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and needycoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zned"));
   ...
   // privacyAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_5));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Needycoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Needycoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Needycoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Needycoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Needycoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Needycoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Needycoin Core help message to get a list with possible Needycoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Needycoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Needycoin network", "", count));
}
...
{
    QString strTitle = tr("Needycoin Core"); // default title
