...
/** Utility functions used by the Needycoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Needycoin addresses in monospace font
...
// Parse "needycoin:" URI into recipient object, return true on successful parsing
