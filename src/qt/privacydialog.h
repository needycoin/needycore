...
public:
    ...
    void setZNeedycoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzned_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzned_clicked();
    void on_pushButtonZNeedycoinControl_clicked();
