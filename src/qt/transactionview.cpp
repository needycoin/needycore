                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Needycoin from zNeedycoin"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zNeedycoin"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zNeedycoin));
