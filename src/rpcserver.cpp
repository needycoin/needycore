...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Needycoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Needycoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Needycoin features */
        {"needycoin", "masternode", &masternode, true, true, false},
        {"needycoin", "listmasternodes", &listmasternodes, true, true, false},
        {"needycoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"needycoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"needycoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"needycoin", "masternodedebug", &masternodedebug, true, true, false},
        {"needycoin", "startmasternode", &startmasternode, true, true, false},
        {"needycoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"needycoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"needycoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"needycoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"needycoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"needycoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"needycoin", "mnbudget", &mnbudget, true, true, false},
        {"needycoin", "preparebudget", &preparebudget, true, true, false},
        {"needycoin", "submitbudget", &submitbudget, true, true, false},
        {"needycoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"needycoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"needycoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"needycoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"needycoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"needycoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"needycoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"needycoin", "checkbudgets", &checkbudgets, true, true, false},
        {"needycoin", "mnsync", &mnsync, true, true, false},
        {"needycoin", "spork", &spork, true, true, false},
        {"needycoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"needycoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use needycoind, or the -server option to needycoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> needycoin-cli " + methodname + " " + args + "\n";
}
